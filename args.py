...
def get_setup_args():
    ...
    parser.add_argument('--dev_meta_file',
                        type=str,
                        default='/floyd/input/squad/dev_meta.json')
    parser.add_argument('--test_meta_file',
                        type=str,
                        default='/floyd/input/squad/test_meta.json')
    parser.add_argument('--word2idx_file',
                        type=str,
                        default='/floyd/input/squad/word2idx.json')
    parser.add_argument('--char2idx_file',
                        type=str,
                        default='/floyd/input/squad/char2idx.json')
    parser.add_argument('--answer_file',
                        type=str,
                        default='/floyd/input/squad/answer.json')
...
def add_common_args(parser):
    ...
    parser.add_argument('--train_record_file',
                        type=str,
                        #default='/floyd/input/squad2/train.npz')
                        default='data/train.npz')
    parser.add_argument('--dev_record_file',
                        type=str,
                        #default='/floyd/input/squad2/dev.npz')
                        default='data/dev.npz')
    parser.add_argument('--test_record_file',
                        type=str,
                        #default='/floyd/input/squad2/test.npz')
                        default='data/test.npz')
    parser.add_argument('--word_emb_file',
                        type=str,
                        #default='/floyd/input/squad2/word_emb.json')
                        default='data/word_emb.json')
    parser.add_argument('--char_emb_file',
                        type=str,
                        #default='/floyd/input/squad2/char_emb.json')
                        default='data/char_emb.json')
    parser.add_argument('--train_eval_file',
                        type=str,
                        #default='/floyd/input/squad2/train_eval.json')
                        default='data/train_eval.json')
    parser.add_argument('--dev_eval_file',
                        type=str,
                        #default='/floyd/input/squad2/dev_eval.json')
                        default='data/dev_eval.json')
    parser.add_argument('--test_eval_file',
                        type=str,
                        #default='/floyd/input/squad2/test_eval.json')
...
def add_train_test_args(parser):
    ...
    parser.add_argument('--save_dir',
                        type=str,
                        default='samsudinng/datasets/squad/',
    ...
    parser.add_argument('--use_char_emb',
                        type=int,
                        default=1,
                        help='Enable/disable character embedding.') 
    parser.add_argument('--char_emb_out_size',
                        type=int,
                        default=100,
                        help='Size of character embedding output vectors.') 
    parser.add_argument('--char_seq_limit',
                        type=int,
                        default=16,
                        help='Size of character embedding output vectors.')                           
